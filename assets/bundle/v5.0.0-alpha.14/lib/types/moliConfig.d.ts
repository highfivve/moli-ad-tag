...
export declare namespace modules {
    ...
    namespace adex {
        interface AdexAppConfig {
            readonly clientTypeKey: string;
            readonly advertiserIdKey: string;
            readonly adexMobileTagId?: string;
        }
        type MappingDefinition = MappingDefinitionToAdexString | MappingDefinitionToAdexNumber | MappingDefinitionToAdexMap | MappingDefinitionToAdexList;
        type AdexListObject = {
            [key: string]: 1;
        };
        type AdexList = {
        ...
        type AdexKeyValuePair = {
            [key: string]: string | number;
        };
        type AdexKeyValueMap = {
            [key: string]: AdexKeyValuePair;
        };
        type AdexKeyValues = AdexKeyValuePair | AdexKeyValueMap | AdexList;
    ...
    namespace blocklist {
        ...
        type StaticBlocklistProvider = {
            readonly provider: 'static';
            readonly blocklist: Blocklist;
        };
        type DynamicBlocklistProvider = {
            readonly provider: 'dynamic';
            readonly endpoint: string;
        };
        type BlocklistProvider = StaticBlocklistProvider | DynamicBlocklistProvider;
    ...
    namespace prebid_first_party_data {
        type GptTargetingMapping = {
            readonly cat?: string;
        ...
        interface PrebidFirstPartyDataModuleConfig extends IModuleConfig {
    ...
    namespace yield_optimization {
        type YieldOptimizationConfigProvider = 'none' | 'static' | 'dynamic';
        type YieldOptimizationConfig = NoYieldOptimizationConfig | StaticYieldOptimizationConfig | DynamicYieldOptimizationConfig;
        type IYieldOptimizationConfig = IModuleConfig & {
            readonly provider: YieldOptimizationConfigProvider;
        };
        type NoYieldOptimizationConfig = IYieldOptimizationConfig & {
            readonly provider: 'none';
        };
        type StaticYieldOptimizationConfig = IYieldOptimizationConfig & {
            readonly provider: 'static';
            readonly config: AdunitPriceRulesResponse;
        };
        type DynamicYieldOptimizationConfig = IYieldOptimizationConfig & {
            readonly provider: 'dynamic';
