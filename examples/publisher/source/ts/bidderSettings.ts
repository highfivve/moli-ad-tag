 ...
 * @returns {string}
 */
const cpmFromBidResponse = (bidResponse: prebidjs.IBidResponse): string => {
 ...
 * @returns {string}
 */
const cpmFromBidResponseAllOneCentSteps = (bidResponse: prebidjs.IBidResponse): string => {
  const cpm = bidResponse.cpm;
